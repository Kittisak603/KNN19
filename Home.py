...
with col3:
    ...
    html_7 = """
<div style="background-color:#E6E6FA;padding:15px;border-radius:15px 15px 15px 15px;border-style:'solid';border-color:black">
...
html_8 = """
<div style="background-color:#FFDAB9;padding:15px;border-radius:15px 15px 15px 15px;border-style:'solid';border-color:black">
